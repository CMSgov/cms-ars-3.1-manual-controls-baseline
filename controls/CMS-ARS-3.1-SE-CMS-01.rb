...
control 'CMS-ARS-3.1-SE-CMS-01' do
  title 'Non-Mandatory: Security Control Family Policy and Procedures '
  desc  "Control:
    The organization: a. Develops, documents, and disseminates to applicable
personnel:    1. Security policy that addresses purpose, scope, roles,
...
of the Security policy and associated Security controls; and b. Reviews and
updates (as necessary) the current:    1. Security policy at least every two
(2) years; and    2. Security procedures at least every two (2) years.
  "
  desc  'check', "
...
as described in the control statements and implementation standard(s).
    ...
    Examine: Privacy's security policy and procedures, and other
relevant documents.Interview: Organizational personnel with
privacy's security responsibilities to ensure responsibilities are
acknowledged.
  "
  desc  'fix', "
...
in the SE family. Policy and procedures reflect applicable federal laws,
...
establishing policy and procedures.
  ...
  tag cms_ars_reference_policy: " E-Gov: §208(b)(2); FIPS Pub: 199; NIST
SP: 800-37, 800-122; OMB Memo: M-06-19, M-17-12, M-03-22, M-16-04; OMB Circular
A-130: Appendix I; Privacy Act: §552a(e), §552a(e)(10),
§552a(i)(1), §552a(m)"
